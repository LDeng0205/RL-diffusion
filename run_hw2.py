...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        ...
        trajectories, envsteps_this_batch = utils.sample_trajectories(env, agent.actor, args.batch_size, max_ep_len) # sampling with diffusion model
        ...
        # Observation: noisified version at timestep t
        # Action: de-noisified verrsion at timestep t-1
        # Reward: 1 T<t
        ...
        if itr % args.scalar_log_freq == 0:
            ...
            logs = utils.compute_metrics(trajectories, eval_trajs)
